        ...
        <div class="col-4">
          <div style="padding-top: 50px" class="candidate-desc">
            ...
            <p class="text-justify">
              ...
              harum laboriosam vitae necessitatibus temporibus magni blanditiis,
              voluptate, quisquam error recusandae ab obcaecati placeat. Quas
              rerum iure ad enim recusandae nesciunt.
            </p>
          </div>
    ...
    <div class="section grey" id="makinig">
      <div class="candidate-desc">
        ...
        <p>
          ...
          laboriosam vitae necessitatibus temporibus magni blanditiis,
          voluptate, quisquam error recusandae ab obcaecati placeat. Quas rerum
          iure ad enim recusandae nesciunt.
        </p>
      </div>
